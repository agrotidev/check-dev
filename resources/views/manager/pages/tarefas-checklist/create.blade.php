          ...
          <div class="col-md-12 mx-0 px-0">
            <form method="post" action="{{ route('manager.checklist.store') }}">
              ...
              <div class="form-group">
                ...
                <label >Nome</label>
                <input class="form-control col-md-6" name="nome" type="text" placeholder="Digite o nome da tarefa">
    
                <label >Descrição</label>
                <input class="form-control col-md-6" name="descricao" type="text" placeholder="Digite a descrição da tarefa">
