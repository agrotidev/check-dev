...
<div class="login-box flipped">
  <form class="forget-form" method="post" action="{{ route('manager.forgot') }}">
      @csrf
      ...
      <div class="form-group mt-3">
          <p class="semibold-text mb-0"><a href="{{ route('manager.login') }}" data-toggle="flip"><i class="fa fa-angle-left fa-fw"></i> Voltar Login</a></p>
      </div>
  </form>
</div>
